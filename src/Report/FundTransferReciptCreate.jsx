...
// const FundTransferReciptCreate = () => {
//   return (
//     <div>
...
// export default FundTransferReciptCreate
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await axios.post(
        `${API}/FundTransfer/FundTransfer/create/receipt`,
        finalData,
      );

      if (res.data.success) {
        alert("Fund Transfer Saved Successfully ✅");
        navigate("/FundTransfer/receipt");
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] font-sans text-gray-800">
      <div className="p-1">
        ...
        <div className="bg-white border border-gray-300 rounded-sm shadow-sm overflow-hidden mb-1">
          ...
          <div className="p-2 grid grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-1">
            ...
            {/* <div className="flex items-center gap-1 lg:col-span-2">
              <label className={labelClass}>Cheque/DD No</label>
              <input
                name="chequeNo"
            ...
            {/* <div className="flex items-center gap-1 lg:col-span-2">
              <label className={labelClass}>Cheque/DD Date</label>
              <input
                name="chequeDate"
        ...
        {/* Table */}
        <div className="bg-white border border-teal-600/40 rounded-sm overflow-hidden border-l-2 border-l-teal-600">
                  ...
                  <td className="p-1 border-r">
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        updatedRows[index].brachId = selectedId;
