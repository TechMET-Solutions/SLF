    ...
    <div className="min-h-screen bg-white font-sans text-[12px] text-gray-800 p-2">
      <div className="">
        ...
        <div className="flex justify-center ">
          <div className="flex items-center justify-between px-6  w-[1462px] min-h-[40px]  border border-gray-200 shadow-sm bg-white gap-6">
        ...
        {/* Table Section */}
        <div className="overflow-x-auto ml-[10px]">
          <table className="w-[1462px] border-collapse border border-gray-300">
            <thead>
            ...
            <tbody>
              {reportData.map((item, index) => (
                <tr key={index} className="hover:bg-blue-50 text-center">
                  ...
                  <td className="border border-gray-300 p-1  cursor-pointer">
                    {item.loanNo}
                  </td>
