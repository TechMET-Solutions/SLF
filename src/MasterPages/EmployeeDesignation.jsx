    ...
    <div className="min-h-screen w-full">
      ...
      {editModalOpen && selectedDesignation && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-[#0101017A] backdrop-blur-md">
          <div className="bg-white w-[396px] rounded-lg shadow-lg h-[320px] p-5">
            <h3 className="text-[22px] font-bold text-center mt-4">
              Edit Designation
            </h3>
            <div className="mt-6 flex flex-col items-center">
              ...
              <input
                ...
                className="border border-gray-400 rounded px-3 py-2 w-[250px] text-sm"
              />
            </div>
            <div className="mt-8 flex justify-center gap-4">
              <button
                onClick={handleEditConfirm}
                className="bg-[#0A2478] text-white px-6 py-2 rounded text-[16px] cursor-pointer"
              >
                Save Changes
              </button>
              <button
                onClick={() => setEditModalOpen(false)}
                className="bg-gray-500 text-white px-6 py-2 rounded text-[16px] cursor-pointer"
              >
                Cancel
              </button>
            </div>
