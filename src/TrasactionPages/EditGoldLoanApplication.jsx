...
const EditGoldLoanApplication = () => {
    ...
    const handleSelectCustomer = (customer, type) => {
        ...
        console.log("setSelectedCustomer", setSelectedCustomer)
    ...
    const fetchLoanData = async () => {
        try {
            ...
            setSearchTerm(`${data.Borrower} (Id - ${data.BorrowerId})`);

            // ✅ CoBorrower (FIXED 🔥)
            setSelectedCoBorrower({
                id: data.CoBorrowerId,
                printName: data.coborrower_printName,
            ...
            setSearchTermForCoBorrower(
                `${data.Co_Borrower} (Id - ${data.CoBorrowerId})`
            );
                                                ...
                                                {results.length > 0 ? (
                                                    results.map((customer, index) => (
                                                        <li
                                                            ...
                                                            className={`px-1 py-1 cursor-pointer ${index === highlightedIndex
                                                                ? "bg-blue-300"
                                                                : "hover:bg-blue-100"
                                                                }`}
                                                        >
                                                    ...
                                                    {results2.length > 0 ? (
                                                        results2.map((customer, index) => (
                                                            <li
                                                                ...
                                                                className={`px-3 py-2 cursor-pointer ${index === highlightedIndexForCoborroer
                                                                    ? "bg-blue-300"
                                                                    : "hover:bg-blue-100"
                                                                    }`}
                                                            >
                        ...
                        <div className="flex gap-10 text-xs">
                            <div>
                                ...
                                <div className="border w-[296px] h-[125px] p-2  overflow-auto">
                                    ...
                                    <p className="text-gray-400 mt-1">Nominee Name :
                                        {selectedCustomer?.Nominee_NomineeName}
                                    </p>
                                    <p className="text-gray-400 mt-1">Nominee Relation :
...
export default EditGoldLoanApplication;