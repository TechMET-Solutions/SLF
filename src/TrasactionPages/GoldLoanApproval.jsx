...
const GoldLoanApproval = () => {
  ...
  // const branchId = userData?.branchId?.id;
      ...
      <div className="min-h-screen space-t-8 w-[1462px] ml-[25px]">
        <div className="flex items-start gap-4 bg-[#FFE6E6] py-4 px-4 w-full border-b border-gray-200">
            ...
            <div className="w-[350px] h-[160px] border border-gray-900 p-2 text-xs flex flex-col justify-between">
              ...
              <div className="space-y-1 text-gray-500">
                ...
                <div className="flex gap-2 items-start  justify-start">
                  <p className="font-mediam  line-clamp-3">
                    {loanData.Address || "N/A"}
                  </p>
                </div>
                <div className="flex gap-2 items-start  justify-start">
                  <p className="font-mediam  line-clamp-3">
                    Nominee Name : {loanData.Nominee || "N/A"}
                  </p>
                </div>
                <div className="flex gap-2 items-start  justify-start">
                  <p className="font-mediam  line-clamp-3">
          ...
          <div className="flex flex-col">
            ...
            <div className="w-[350px] h-[160px] border border-gray-900 p-2 text-xs flex flex-col justify-between">
              ...
              <div className="space-y-1 text-gray-500">
                ...
                <div className="flex gap-2 items-start  justify-start">
                  <p className="font-mediam  line-clamp-3">
                    {loanData.coBorrower_Permanent_Address || "N/A"}
                  </p>
                </div>
                <div className="flex gap-2 items-start  justify-start">
                  <p className="font-mediam  line-clamp-3">
                    Nominee Name :{" "}
                    {loanData.coBorrower_Nominee_NomineeName || "N/A"}
                  </p>
                </div>
                <div className="flex gap-2 items-start  justify-start">
                  <p className="font-mediam  line-clamp-3">
                    Nominee Relation :{" "}
                    {loanData.coBorrower_Nominee_Relation || "N/A"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex gap-4 ml-auto">
            ...
            {/* Co-Borrower Media */}
            <div className="flex flex-col items-center gap-1">
              <span className="text-sm font-semibold">Co-Borrower</span>
              <div className="w-24 h-24 border border-blue-300 bg-white/50 rounded">
                <img
        ...
        <div className=" bg-[#E9E9FF] p-4">
          <div className="w-full text-xs border border-gray-300 overflow-x-auto">
            ...
            <div className="flex bg-[#0A2478] text-white font-semibold min-w-max">
              ...
              <div className="w-32 p-2 border-r border-white/20 text-center">
                Calculated Purity
              </div>
              <div className="w-24 p-2 border-r border-white/20 text-center">
                Rate
            ...
            {pledgeItems.length > 0 ? (
              <>
                {pledgeItems.map((item, index) => (
                  <div
                    key={item.id || index}
                    className={`flex border-t border-gray-300 min-w-max ${
                ...
                <div className="flex border-t bg-gray-100 border-gray-300 min-w-max">
                  <div className="flex-1 p-2 border-r border-gray-300 font-bold text-right pr-4">
                    Total
                  </div>
                  ...
                  <div className="w-28 p-2 border-r border-gray-300 text-center font-bold">
                        ...
                        {row.paidBy === "Cash" ? (
                          ...
                          >
                            ...
                            {BorrowerBankDetails.map((bank) => (
                              <option
                                key={bank.id}
                                value={`${bank.bankName} - ${bank.Account_No}`}
                              >
          ...
          <div className="w-1/2">
            ...
            <div className="border border-gray-300 rounded overflow-hidden">
              <div className="flex bg-[#0A2478] text-white font-semibold">
                ...
                <div className="flex-1 p-2 text-center">Max Loan</div>
              </div>
          ...
          <div className="w-1/2 ">
            ...
            <div className="border border-gray-300 rounded overflow-hidden">
              <div className="flex bg-[#0A2478] text-white font-semibold">
                ...
                <div className="flex-1 p-2  text-center">Interest Rate</div>
              </div>
              ...
              {interestRates.length > 0 ? (
                interestRates.map((rate, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 p-2 text-center">{rate.addInt}%</div>
                  </div>
                ))
              ) : (
