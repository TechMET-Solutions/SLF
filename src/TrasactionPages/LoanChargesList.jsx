...
function LoanChargesList() {
  ...
  const allHeaderIds = ["loan_no", "party_name", "total_charges"];
          ...
          <div className="flex gap-3">
            ...
            {(userData?.isAdmin ||
              permissions?.Transaction?.find(
                (item) => item.name === "Loan Charges List",
              )?.add) && (
              <button
            ...
            {isLoading ? (
              ...
              <table className="w-full border-collapse">
                ...
                <thead className="bg-[#0A2478] text-white text-sm">
                  <tr>
                    <th className="px-1 py-1 text-left border-r w-[130px]">
                      Loan No
                    </th>
